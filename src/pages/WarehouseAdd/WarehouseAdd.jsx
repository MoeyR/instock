                ...
                <section className='form-wrap'>
                    ...
                    <section className='form__label-inputs-wrap'>
                        ...
                        <label className='form__labels' >
                            ...
                            <input className='form-input' type="text" id='warehouseName' placeholder='Warehouse Name'/>
                        </label>
                        <label className='form__labels' htmlFor="address">
                            <h3 className="label-text">Street Address</h3>
                            <input className='form-input' type="text" id='address' placeholder='Street Address'/>
                        </label>
                        ...
                        <label className='form__labels' htmlFor="country">
                            ...
                            <input className='form-input' type="text" id='country' placeholder='Country'/>
                        </label>
                    </section>
                    {/* contact details */}
                    <section className='form__label-inputs-wrap'>
                        ...
                        <label className='form__labels' htmlFor="contactName">
                            ...
                            <input className='form-input' type="text" id='contactName' placeholder='Contact Name'/>
                        </label>
                        <label className='form__labels' htmlFor="position">
                            <h3 className="label-text">Position</h3>
                            <input className='form-input' type="text" id='position' placeholder='Position'/>
                        </label>
